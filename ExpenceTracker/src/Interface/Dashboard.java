...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setFocusable(false);
        setPreferredSize(new java.awt.Dimension(1051, 825));
        setResizable(false);
        ...
        addExpenseButton.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                addExpenseButtonKeyPressed(evt);
            }
        });
 ...
 */  
    ...
    private void amountFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_amountFieldKeyTyped
        // TODO add your handling code here:
        char amt = evt.getKeyChar();
        if(Character.isAlphabetic(amt)){
            evt.consume();
        }
    }//GEN-LAST:event_amountFieldKeyTyped

    private void addExpenseButtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_addExpenseButtonKeyPressed
        // TODO add your handling code here:
       
    }//GEN-LAST:event_addExpenseButtonKeyPressed

    private void amountFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_amountFieldKeyPressed
        // TODO add your handling code here:
         if(evt.getKeyCode() == evt.VK_ENTER){
            addExpenseButtonActionPerformed(null);
        }
